...
<div class="container custom-login">
    <div class="row">
      <div class="col-sm-4 col-sm-offset-4" >
        ...
        <form action="{{route('update_user_profile',Auth::user()->id)}}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="email" name="email" readonly value="{{$users->email}}" class="form-control" id="exampleInputEmail1" placeholder="Email">
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Password</label>
                <input type="password" name="password" readonly  class="form-control" id="exampleInputEmail1" placeholder="Password">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="number" name="solde_conge" readonly class="form-control" value="{{$users->solde_conge}}" id="exampleInputEmail1" placeholder="Solde Congé">
              </div>
